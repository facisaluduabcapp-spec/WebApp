  ...
  <section id="descargar" style={{ background: C.greenFaint, padding: '5rem 2rem', borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}` }}>
    <div style={{ maxWidth: 760, margin: '0 auto' }}>
      <div style={{
       ...
       <a href="/ManualUsuario-VIHAPP.pdf" download="ManualUsuario-VIHAPP.pdf" style={{ 
            color: C.green, 
            textDecoration: 'none', 
            fontWeight: 600, 
            fontSize: '0.88rem', 
...
function App() {
  ...
  const APK_URL  = 'https://firebasestorage.googleapis.com/v0/b/facisalud-afced.firebasestorage.app/o/application-25052026.apk?alt=media&token=fc2ff43c-39f8-43b1-a724-137a0001fef0';
